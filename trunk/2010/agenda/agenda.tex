...
\begin{tabular}{rlrlp{5in}} % right left right (for start/hyphen/end)
  ...
  %\multicolumn{5}{l}{\Huge \textbf{\color{KeynoteTalk} R/Finance 2010}} \\
  ...
  \multicolumn{5}{l}{\Huge \textbf{\color{KeynoteTalk} R/Finance 2010} \phantom{i} \huge \textsf{Applied Finance with R}} \\
  ...
  \phantom{XXX} 12:30pm&--&1:30pm & \phantom{l} & \textbf{\color{KeynoteTalk} Zeileis}: \small{Testing, Monitoring and Dating Structural Change in FX Regimes} \\
